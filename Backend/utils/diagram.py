...
def edit_diagram_mermaid(user_prompt: str, existing_mermaid_code: str) -> str:
    """
    Calls OpenAI API to edit/update existing Mermaid UML diagram code based on user prompt.
...
Please update the diagram according to the user's request and return the complete updated Mermaid code."""
        ...
        # Extract Mermaid code (in case model wraps it in markdown)
        updated_mermaid_code = extract_mermaid_code(raw_answer)
